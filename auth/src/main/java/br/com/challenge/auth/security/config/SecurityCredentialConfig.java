package br.com.challenge.auth.security.config;

import br.com.challenge.auth.security.filter.JwtUsernameAndPasswordAuthenticationFilter;
...
public class SecurityCredentialConfig extends SecurityTokenConfig {
    ...
    public SecurityCredentialConfig(JwtConfiguration jwtConfiguration, @Qualifier("userDetailsServiceImpl") UserDetailsService userDetailsService, TokenCreator tokenCreator, TokenConverter tokenConverter) {
