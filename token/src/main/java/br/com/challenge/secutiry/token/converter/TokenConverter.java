package br.com.challenge.secutiry.token.converter;
...
public class TokenConverter {
    ...
    public void validateTokenSignature(String signedToken) {
        log.info("Starting method to vlaidate token signature . . .");
        SignedJWT signedJWT = SignedJWT.parse(signedToken);
        log.info("Token Parsed! Retrieving public key from signed tokken");
